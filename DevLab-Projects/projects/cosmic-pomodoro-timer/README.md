...
![cosmic](https://img.shields.io/badge/Design-cosmic-blueviolet)
...
Pomodoro timer with cosmic space theme and animations

This project showcases a premium **cosmic** design system, creating an unforgettable user experience with cutting-edge web technologies.
...
**Cosmic** - A unique and premium design system featuring:
...
[View Live Demo](https://ashrafmorningstar.github.io/web-dev-mega-projects/cosmic-pomodoro-timer)

## 💻 Technologies

- HTML5
- CSS3 (cosmic Design System)
- Vanilla JavaScript
- Modern Web APIs
...
# Navigate to project
cd web-dev-mega-projects/projects/cosmic-pomodoro-timer
