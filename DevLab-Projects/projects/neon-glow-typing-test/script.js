...
/**
 * Neon Glow Typing Test - Interactive Logic
 * Author: Ashraf Morningstar
 * GitHub: https://github.com/AshrafMorningstar
 */

class NeonGlowTypingTestApp {
    constructor() {
        this.init();
    }

    init() {
        console.log('%c Neon Glow Typing Test Initialized ', 'background: linear-gradient(135deg, #00ffff, #ffff00); color: white; padding: 10px; font-weight: bold;');
