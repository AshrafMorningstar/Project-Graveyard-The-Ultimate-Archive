...
/**
 * Glassmorphic Calendar - Interactive Logic
 * Author: Ashraf Morningstar
 * GitHub: https://github.com/AshrafMorningstar
 */

class GlassmorphicCalendarApp {
    constructor() {
        this.init();
    }

    init() {
        console.log('%c Glassmorphic Calendar Initialized ', 'background: linear-gradient(135deg, #667eea, #764ba2); color: white; padding: 10px; font-weight: bold;');
