...
import { Moon, Sun, Monitor, Volume2, Cpu, HardDrive } from 'lucide-react';

const Settings: React.FC = () => {
  const { settings, setWallpaper, setAccentColor, toggleTheme, toggleCrtEffect } = useStore();
        ...
        <div className="space-y-8">
            ...
            <section className={`p-6 rounded-2xl border ${isDark ? 'bg-white/5 border-white/10' : 'bg-white border-gray-200'}`}>
                <div className="flex items-center gap-4 mb-6">
                    <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-neuro-purple to-quantum-cyan flex items-center justify-center text-3xl shadow-lg">
                        
                    </div>
                    <div>
