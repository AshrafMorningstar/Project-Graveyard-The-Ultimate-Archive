...
export default function Window({ id, title, icon, children }: WindowProps) {
  ...
  return (
    <div
      ref={windowRef}
      className={`fixed bg-[#15192c] dark:bg-[#15192c] bg-white/90 backdrop-blur-xl border border-indigo-500/20 dark:border-indigo-500/20 border-gray-200/50 rounded-2xl shadow-2xl flex flex-col overflow-hidden group transition-all duration-500 cubic-bezier(0.34, 1.56, 0.64, 1) ${
        window.minimized ? 'opacity-0 scale-75 pointer-events-none translate-y-[100px] blur-sm' : 'opacity-100 scale-100 blur-0'
      }`}
      style={{
        minWidth: '500px',
        minHeight: '400px',
