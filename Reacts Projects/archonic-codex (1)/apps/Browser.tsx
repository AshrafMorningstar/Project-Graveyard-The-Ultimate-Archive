...
import { ArrowLeft, ArrowRight, RotateCw, Lock, Star, Github, ExternalLink, Code, Search } from 'lucide-react';
         ...
         <div className="max-w-6xl mx-auto">
            <div className="flex flex-col sm:flex-row items-center justify-between mb-8 gap-4">
                <div className="text-center sm:text-left">
                    <h1 className="text-3xl sm:text-4xl font-display font-bold text-white mb-2">Project Nebula</h1>
                    <p className="text-gray-400">Explore the quantum creations.</p>
                </div>
                <div className="flex items-center gap-4">
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="pl-10 pr-4 py-2 bg-white/5 border border-white/10 rounded-full text-sm text-white focus:outline-none focus:border-blue-500 transition-colors w-64"
                            value={searchQuery}
                    ...
                    <button 
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-white text-black rounded-full font-bold hover:bg-gray-200 transition-colors shadow-lg shadow-white/10 text-sm"
                    >
                        <Github size={18} />
                ...
                <AnimatePresence>
                    {filteredProjects.map((project, idx) => (
                        <motion.div 
                            ...
                            key={project.title} 
                            className="group relative bg-[#1e1e24] rounded-2xl overflow-hidden border border-white/5 hover:border-white/20 transition-all hover:translate-y-[-6px] hover:shadow-2xl hover:shadow-blue-500/10 flex flex-col h-full"
                        >
                            ...
                            <div className="p-6 flex-1 flex flex-col">
                                ...
                                <button 
                                    ...
                                    className="w-full py-2 flex items-center justify-center gap-2 text-sm font-medium bg-white/5 hover:bg-white/10 rounded-lg text-white transition-colors border border-white/5 group-hover:bg-blue-600 group-hover:border-blue-500"
                                >
