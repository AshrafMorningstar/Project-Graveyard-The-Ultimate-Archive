...
export const APPS_CONFIG: AppConfig[] = [
  ...
  { id: 'projects', title: 'Project Nebula', icon: Globe, component: <Browser />, width: 1000, height: 700, isFull: true, installed: true, category: 'Productivity' },
  ...
  useEffect(() => {
    if (!isBooting && !isLocked) {
        ...
        setTimeout(() => {
            addNotification({
                title: 'System Online',
                message: 'Neural Interface Active. Welcome back, Guest.',
            });
        }, 1500);
    }
  }, [isBooting, isLocked]);
