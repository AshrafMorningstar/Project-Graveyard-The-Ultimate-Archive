...
export const Browser: React.FC = () => {
    const [tabs, setTabs] = useState<Tab[]>([
        { id: 1, title: 'New Tab', url: 'https://jsmfolio.netlify.app/', loading: false, history: ['https://jsmfolio.netlify.app/'], historyIndex: 0 }
    ]);
    ...
    const navigate = (newUrl: string) => {
        ...
        if (finalUrl.includes('github.com/AshrafMorningstar')) {
        ...
        <div className="flex flex-col h-full bg-[#1e1e24] text-gray-200">
            ...
            <div className="h-12 bg-[#2d2d35] flex items-center px-4 gap-4 border-b border-black/20 shrink-0">
                <div className="flex gap-2 text-gray-400">
                    ...
                    <button onClick={goForward} disabled={activeTab.historyIndex === activeTab.history.length - 1} className="hover:text-white disabled