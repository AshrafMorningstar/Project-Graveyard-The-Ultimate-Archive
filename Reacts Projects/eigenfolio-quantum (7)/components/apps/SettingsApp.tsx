          ...
          <div className="flex gap-4 mb-6">
           ...
           <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-white/10">
                <div className="flex items-center justify-between">
                    ...
                    <select className="bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg px-3 py-1 text-sm outline-none">
                        <option>Quantum Void (Default)</option>
                        <option>Cyberpunk City</option>
                        <option>Nebula Drift</option>
                    </select>
                </div>
                <div className="flex items-center justify-between">
