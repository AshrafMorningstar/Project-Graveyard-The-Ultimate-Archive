...
import { 
  Terminal, Folder, Code2, Brain, Gamepad2, User, Settings, Activity, StickyNote, Radio, Calendar, PenTool, Globe, Calculator, FileText
} from 'lucide-react';
...
export const NebulaDock: React.FC = () => {
  ...
  const DOCK_APPS: { id: AppID, name: string, icon: any, color: string }[] = [
    ...
    { id: 'explorer', name: 'Files', icon: Folder, color: 'text-yellow-400' }, // Changed from projects
