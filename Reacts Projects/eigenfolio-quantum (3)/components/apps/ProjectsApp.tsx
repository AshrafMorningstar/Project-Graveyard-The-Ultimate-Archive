      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {filteredProjects.map((p, i) => (
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-6 h-12 leading-relaxed line-clamp-2">{p.desc}</p>
            ...
            <div className="flex items-center gap-4 text-xs text-gray-500 border-t border-gray-100 dark:border-white/5 pt-4">
