...
import { User, Folder, Brain, PenTool, Gamepad2, Settings, Terminal, Files, Code2, Radio, Globe, Palette, Calculator, Camera, StickyNote } from 'lucide-react';
...
const NebulaDock: React.FC<NebulaDockProps> = ({ openApps, onOpenApp }) => {
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-[100] w-full max-w-[90vw] overflow-x-auto overflow-y-hidden pb-2 scrollbar-hide flex justify-center">
