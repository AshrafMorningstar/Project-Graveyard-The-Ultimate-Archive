                ...
                {loading ? (
                    <div className="h-full flex items-center justify-center">
                        <div className="relative">
                            <div className="w-20 h-20 border-4 border-blue-500/30 rounded-full animate-[spin_3s_linear_infinite]"></div>
                            <div className="absolute inset-0 border-4 border-purple-500/30 rounded-full animate-[spin_2s_linear_infinite_reverse] scale-75"></div>
                            <div className="absolute inset-0 flex items-center justify-center text-xs font-mono animate-pulse text-white">INITIALIZING</div>
                        </div>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-12">
                        {PROJECTS.map((project, index) => (
                            <motion.div
                                ...
                                className="group relative bg-[#15151a] rounded-xl overflow-hidden border border-white/5 transition-all duration-300 flex flex-col h-full"
                            >
                                <div className="aspect-video relative overflow-hidden">
                                    <img src={project.image} alt={project.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                                    <div className="absolute inset-0 bg-gradient-to-t from-[#15151a] to-transparent opacity-90" />
