...
import { ExternalLink, GitBranch, Star, Filter, X, Globe, Github, Search } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {filteredProjects.map((p, i) => (
          <div 
            ...
            className="group bg-white dark:bg-chronos-dark border border-gray-200 dark:border-white/5 rounded-2xl p-6 hover:shadow-2xl hover:border-neuro-purple/50 transition-all duration-300 relative overflow-hidden shadow-sm animate-quantum-materialize opacity-0 fill-mode-forwards cursor-pointer hover:-translate-y-2"
          >
            {/* Shimmer Effect */}
