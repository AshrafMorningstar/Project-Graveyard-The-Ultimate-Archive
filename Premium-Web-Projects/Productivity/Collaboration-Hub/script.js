...
// Collaboration-Hub by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Collaboration-Hub!', 'info');
...
console.log('%cCollaboration-Hub', 'font-size: 24px; font-weight: bold; color: #667eea;');
