...
// Calendar-Scheduler by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Calendar-Scheduler!', 'info');
...
console.log('%cCalendar-Scheduler', 'font-size: 24px; font-weight: bold; color: #667eea;');
