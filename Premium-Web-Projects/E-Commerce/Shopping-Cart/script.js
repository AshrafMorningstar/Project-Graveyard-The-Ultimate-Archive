...
// Shopping-Cart by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Shopping-Cart!', 'info');
...
console.log('%cShopping-Cart', 'font-size: 24px; font-weight: bold; color: #667eea;');
