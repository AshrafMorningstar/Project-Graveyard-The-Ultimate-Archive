...
// Price-Comparison by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Price-Comparison!', 'info');
...
console.log('%cPrice-Comparison', 'font-size: 24px; font-weight: bold; color: #667eea;');
