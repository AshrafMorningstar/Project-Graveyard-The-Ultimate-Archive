...
// Checkout-Flow by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Checkout-Flow!', 'info');
...
console.log('%cCheckout-Flow', 'font-size: 24px; font-weight: bold; color: #667eea;');
