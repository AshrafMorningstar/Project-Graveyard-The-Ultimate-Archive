...
// Inventory-Tracker by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Inventory-Tracker!', 'info');
...
console.log('%cInventory-Tracker', 'font-size: 24px; font-weight: bold; color: #667eea;');
