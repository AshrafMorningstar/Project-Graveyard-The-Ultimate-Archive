...
// Review-System by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Review-System!', 'info');
...
console.log('%cReview-System', 'font-size: 24px; font-weight: bold; color: #667eea;');
