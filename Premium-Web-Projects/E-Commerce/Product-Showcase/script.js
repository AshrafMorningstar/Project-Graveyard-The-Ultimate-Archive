...
// Product-Showcase by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Product-Showcase!', 'info');
...
console.log('%cProduct-Showcase', 'font-size: 24px; font-weight: bold; color: #667eea;');
