...
// Coupon-Generator by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Coupon-Generator!', 'info');
...
console.log('%cCoupon-Generator', 'font-size: 24px; font-weight: bold; color: #667eea;');
