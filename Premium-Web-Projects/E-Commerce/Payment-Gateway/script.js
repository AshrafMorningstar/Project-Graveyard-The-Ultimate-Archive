...
// Payment-Gateway by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Payment-Gateway!', 'info');
...
console.log('%cPayment-Gateway', 'font-size: 24px; font-weight: bold; color: #667eea;');
