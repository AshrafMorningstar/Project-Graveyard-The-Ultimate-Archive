...
// Order-Dashboard by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Order-Dashboard!', 'info');
...
console.log('%cOrder-Dashboard', 'font-size: 24px; font-weight: bold; color: #667eea;');
