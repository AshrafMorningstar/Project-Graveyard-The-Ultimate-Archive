...
// Wishlist-Manager by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Wishlist-Manager!', 'info');
...
console.log('%cWishlist-Manager', 'font-size: 24px; font-weight: bold; color: #667eea;');
