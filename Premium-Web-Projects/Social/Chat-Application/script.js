...
// Chat-Application by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Chat-Application!', 'info');
...
console.log('%cChat-Application', 'font-size: 24px; font-weight: bold; color: #667eea;');
