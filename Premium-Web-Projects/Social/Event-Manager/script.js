...
// Event-Manager by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Event-Manager!', 'info');
...
console.log('%cEvent-Manager', 'font-size: 24px; font-weight: bold; color: #667eea;');
