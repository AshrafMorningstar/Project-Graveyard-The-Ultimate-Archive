...
// Media-Aggregator by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Media-Aggregator!', 'info');
...
console.log('%cMedia-Aggregator', 'font-size: 24px; font-weight: bold; color: #667eea;');
