...
// Profile-Builder by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Profile-Builder!', 'info');
...
console.log('%cProfile-Builder', 'font-size: 24px; font-weight: bold; color: #667eea;');
