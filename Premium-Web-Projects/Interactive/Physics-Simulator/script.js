...
// Physics-Simulator by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Physics-Simulator!', 'info');
...
console.log('%cPhysics-Simulator', 'font-size: 24px; font-weight: bold; color: #667eea;');
