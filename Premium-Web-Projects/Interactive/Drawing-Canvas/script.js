...
// Drawing-Canvas by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Drawing-Canvas!', 'info');
...
console.log('%cDrawing-Canvas', 'font-size: 24px; font-weight: bold; color: #667eea;');
