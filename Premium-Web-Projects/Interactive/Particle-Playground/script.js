...
// Particle-Playground by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Particle-Playground!', 'info');
...
console.log('%cParticle-Playground', 'font-size: 24px; font-weight: bold; color: #667eea;');
