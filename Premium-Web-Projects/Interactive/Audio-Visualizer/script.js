...
// Audio-Visualizer by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Audio-Visualizer!', 'info');
...
console.log('%cAudio-Visualizer', 'font-size: 24px; font-weight: bold; color: #667eea;');
