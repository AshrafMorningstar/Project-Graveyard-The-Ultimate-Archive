...
// Interactive-Story by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Interactive-Story!', 'info');
...
console.log('%cInteractive-Story', 'font-size: 24px; font-weight: bold; color: #667eea;');
