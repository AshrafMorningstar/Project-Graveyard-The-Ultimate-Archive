...
// 3D-Product-Showcase by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to 3D-Product-Showcase!', 'info');
...
console.log('%c3D-Product-Showcase', 'font-size: 24px; font-weight: bold; color: #667eea;');
