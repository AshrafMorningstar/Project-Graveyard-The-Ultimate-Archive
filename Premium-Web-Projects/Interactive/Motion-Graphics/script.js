...
// Motion-Graphics by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Motion-Graphics!', 'info');
...
console.log('%cMotion-Graphics', 'font-size: 24px; font-weight: bold; color: #667eea;');
