...
document.addEventListener('DOMContentLoaded', () => {
    createParticles();
    showNotification('Welcome to Real-Time-Analytics-Dashboard!', 'success');
...
console.log('%cReal-Time-Analytics-Dashboard', 'font-size: 24px; font-weight: bold; color: #667eea;');
