...
// Assignment-Manager by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Assignment-Manager!', 'info');
...
console.log('%cAssignment-Manager', 'font-size: 24px; font-weight: bold; color: #667eea;');
