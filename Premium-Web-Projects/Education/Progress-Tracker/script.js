...
// Progress-Tracker by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Progress-Tracker!', 'info');
...
console.log('%cProgress-Tracker', 'font-size: 24px; font-weight: bold; color: #667eea;');
