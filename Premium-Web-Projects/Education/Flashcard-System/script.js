...
// Flashcard-System by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Flashcard-System!', 'info');
...
console.log('%cFlashcard-System', 'font-size: 24px; font-weight: bold; color: #667eea;');
