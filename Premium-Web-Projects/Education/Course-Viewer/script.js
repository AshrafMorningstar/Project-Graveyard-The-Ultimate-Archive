...
// Course-Viewer by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Course-Viewer!', 'info');
...
console.log('%cCourse-Viewer', 'font-size: 24px; font-weight: bold; color: #667eea;');
