...
// Learning-Platform by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Learning-Platform!', 'info');
...
console.log('%cLearning-Platform', 'font-size: 24px; font-weight: bold; color: #667eea;');
