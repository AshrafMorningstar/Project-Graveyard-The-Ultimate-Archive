...
// Resource-Library by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Resource-Library!', 'info');
...
console.log('%cResource-Library', 'font-size: 24px; font-weight: bold; color: #667eea;');
