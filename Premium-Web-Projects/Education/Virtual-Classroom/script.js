...
// Virtual-Classroom by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Virtual-Classroom!', 'info');
...
console.log('%cVirtual-Classroom', 'font-size: 24px; font-weight: bold; color: #667eea;');
