...
// Grade-Calculator by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Grade-Calculator!', 'info');
...
console.log('%cGrade-Calculator', 'font-size: 24px; font-weight: bold; color: #667eea;');
