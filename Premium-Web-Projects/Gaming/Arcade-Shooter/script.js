...
// Arcade-Shooter by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Arcade-Shooter!', 'info');
...
console.log('%cArcade-Shooter', 'font-size: 24px; font-weight: bold; color: #667eea;');
