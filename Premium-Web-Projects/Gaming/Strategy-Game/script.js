...
// Strategy-Game by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Strategy-Game!', 'info');
...
console.log('%cStrategy-Game', 'font-size: 24px; font-weight: bold; color: #667eea;');
