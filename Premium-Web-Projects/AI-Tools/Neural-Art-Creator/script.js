...
// Neural-Art-Creator by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Neural-Art-Creator!', 'info');
...
console.log('%cNeural-Art-Creator', 'font-size: 24px; font-weight: bold; color: #667eea;');
