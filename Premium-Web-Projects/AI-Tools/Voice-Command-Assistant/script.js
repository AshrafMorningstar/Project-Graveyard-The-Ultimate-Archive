...
// Voice-Command-Assistant by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Voice-Command-Assistant!', 'info');
...
console.log('%cVoice-Command-Assistant', 'font-size: 24px; font-weight: bold; color: #667eea;');
