...
// Chatbot-Builder by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Chatbot-Builder!', 'info');
...
console.log('%cChatbot-Builder', 'font-size: 24px; font-weight: bold; color: #667eea;');
