...
// AI-Content-Generator by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to AI-Content-Generator!', 'info');
...
console.log('%cAI-Content-Generator', 'font-size: 24px; font-weight: bold; color: #667eea;');
