...
// Predictive-Analytics by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Predictive-Analytics!', 'info');
...
console.log('%cPredictive-Analytics', 'font-size: 24px; font-weight: bold; color: #667eea;');
