...
// Code-Generator by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Code-Generator!', 'info');
...
console.log('%cCode-Generator', 'font-size: 24px; font-weight: bold; color: #667eea;');
