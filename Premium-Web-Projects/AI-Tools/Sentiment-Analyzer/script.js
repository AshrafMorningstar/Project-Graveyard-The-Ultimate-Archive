...
// Sentiment-Analyzer by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Sentiment-Analyzer!', 'info');
...
console.log('%cSentiment-Analyzer', 'font-size: 24px; font-weight: bold; color: #667eea;');
