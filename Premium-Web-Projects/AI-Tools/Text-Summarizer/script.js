...
// Text-Summarizer by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Text-Summarizer!', 'info');
...
console.log('%cText-Summarizer', 'font-size: 24px; font-weight: bold; color: #667eea;');
