...
// Smart-Image-Enhancer by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Smart-Image-Enhancer!', 'info');
...
console.log('%cSmart-Image-Enhancer', 'font-size: 24px; font-weight: bold; color: #667eea;');
