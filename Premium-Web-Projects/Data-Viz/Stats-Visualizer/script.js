...
// Stats-Visualizer by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Stats-Visualizer!', 'info');
...
console.log('%cStats-Visualizer', 'font-size: 24px; font-weight: bold; color: #667eea;');
