...
// Heatmap-Generator by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Heatmap-Generator!', 'info');
...
console.log('%cHeatmap-Generator', 'font-size: 24px; font-weight: bold; color: #667eea;');
