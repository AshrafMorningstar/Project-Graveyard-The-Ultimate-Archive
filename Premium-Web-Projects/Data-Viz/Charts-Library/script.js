...
// Charts-Library by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Charts-Library!', 'info');
...
console.log('%cCharts-Library', 'font-size: 24px; font-weight: bold; color: #667eea;');
