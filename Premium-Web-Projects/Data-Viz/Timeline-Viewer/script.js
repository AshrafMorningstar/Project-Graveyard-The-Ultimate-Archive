...
// Timeline-Viewer by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Timeline-Viewer!', 'info');
...
console.log('%cTimeline-Viewer', 'font-size: 24px; font-weight: bold; color: #667eea;');
