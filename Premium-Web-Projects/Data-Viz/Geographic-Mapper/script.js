...
// Geographic-Mapper by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Geographic-Mapper!', 'info');
...
console.log('%cGeographic-Mapper', 'font-size: 24px; font-weight: bold; color: #667eea;');
