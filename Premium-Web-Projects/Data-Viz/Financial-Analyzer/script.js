...
// Financial-Analyzer by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Financial-Analyzer!', 'info');
...
console.log('%cFinancial-Analyzer', 'font-size: 24px; font-weight: bold; color: #667eea;');
