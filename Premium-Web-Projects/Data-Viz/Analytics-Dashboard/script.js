...
// Analytics-Dashboard by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Analytics-Dashboard!', 'info');
...
console.log('%cAnalytics-Dashboard', 'font-size: 24px; font-weight: bold; color: #667eea;');
