...
// Unit-Converter by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Unit-Converter!', 'info');
...
console.log('%cUnit-Converter', 'font-size: 24px; font-weight: bold; color: #667eea;');
