...
// Screenshot-Tool by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Screenshot-Tool!', 'info');
...
console.log('%cScreenshot-Tool', 'font-size: 24px; font-weight: bold; color: #667eea;');
