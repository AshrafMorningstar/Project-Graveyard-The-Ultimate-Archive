...
// Calculator-Pro by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Calculator-Pro!', 'info');
...
console.log('%cCalculator-Pro', 'font-size: 24px; font-weight: bold; color: #667eea;');
