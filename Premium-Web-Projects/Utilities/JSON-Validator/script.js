...
// JSON-Validator by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to JSON-Validator!', 'info');
...
console.log('%cJSON-Validator', 'font-size: 24px; font-weight: bold; color: #667eea;');
