...
// File-Organizer by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to File-Organizer!', 'info');
...
console.log('%cFile-Organizer', 'font-size: 24px; font-weight: bold; color: #667eea;');
