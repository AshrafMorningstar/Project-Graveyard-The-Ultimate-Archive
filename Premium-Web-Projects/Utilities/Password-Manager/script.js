...
// Password-Manager by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Password-Manager!', 'info');
...
console.log('%cPassword-Manager', 'font-size: 24px; font-weight: bold; color: #667eea;');
