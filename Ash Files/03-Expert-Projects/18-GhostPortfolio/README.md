...
> **Invisible assets. A cryptocurrency and asset tracker with privacy focus. Minimalist numbers, maximum insight. The shadow finance tool.**
...
1. Clone the repository:
   ```bash
   git clone https://github.com/AshrafMorningstar/GhostPortfolio.git
   ```
